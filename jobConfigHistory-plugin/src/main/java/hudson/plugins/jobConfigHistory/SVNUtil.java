...
/**
 * Used to get svn details for sync repo
 */
public class SVNUtil {  
     ...
     * authenication
     * @param  svnRoot: 
     * @param  username: username for svn repo to sync to 
     * @param  password: password of svn repo to sync to
     */  
    ...
    /** 
     * make sure the path is a working copy
     * @param path 
     * @return true if svn is a working copy, false otherwise
     */  
     ...
     * @param url for the svn repository
     * @param username for the svn repository
     * @param password for the svn repository
     * @return false is url doesn't exist othrwise true if it does
     */  
    ...
    /** 
     * get the version of svn
     * @param url for the svn repository
     * @param username for the svn repository
     * @param password for the svn repository
     * @return null if can't get svnRepostory, otherwise return string of svn version
     */ 
    public static String get_svn_version(SVNURL url,String username,String password)
    {
    	try {  
            SVNRepository svnRepository = SVNRepositoryFactory.create(url);  
            ISVNAuthenticationManager authManager = SVNWCUtil.createDefaultAuthenticationManager(username, password);  
            svnRepository.setAuthenticationManager(authManager);  
            long version = svnRepository.getDatedRevision(new Date());
